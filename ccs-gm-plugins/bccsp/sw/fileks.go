...
func (ks *fileBasedKeyStore) storePrivateKey(alias string, privateKey *sm2.PrivateKey) error {
...
func (ks *fileBasedKeyStore) storePublicKey(alias string, publicKey *sm2.PublicKey) error {
