...
import (
	...
	//"github.com/Hyperledger-TWGC/fabric-plugins/core/common/sm2"
	//"github.com/Hyperledger-TWGC/fabric-plugins/core/common/x509"
...
func TestInit(t *testing.T) {
	...
	pkRaw, err :=  gmX509.MarshalPKISM2PublicKey(&k.PublicKey)
	assert.NoError(t, err)
